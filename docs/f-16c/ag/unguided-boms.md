...
高抵抗爆弾は減速することで、低高度で投下しても爆発の影響に巻き込まれることはありません。
...
目標指示ポッドを装備している場合は、レーザー照射することにより投下精度を向上させることができます。
...
- 目標指示ポッド (TGP) が装備されている場合、それを用いて目標をデジグネートします
